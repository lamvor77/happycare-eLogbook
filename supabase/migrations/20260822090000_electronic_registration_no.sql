...
-- ============================================================================
-- [운영 DB 상태 — 2026-08-24] 이 파일이 의도한 객체들은 이 파일 단독
-- 실행이 아니라 20260823090000/20260824090000/20260824091000의 후속
-- hotfix까지 합쳐진 결과로 운영 DB에 모두 존재하며, 실제 QR 등록 1건으로
-- 끝까지(E-등록번호 생성 → Sheet 동기화) 검증 완료됐다. 이 파일을 단독
-- 재실행하지 않는다 — 상세 현황은
-- docs/legacy-sync-integration.md "운영 DB 적용 이력" 절 참고.
-- ============================================================================
