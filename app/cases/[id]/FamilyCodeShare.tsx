 ...
 * 가족코드 표시 + 복사/공유.
 *
 * 다른 가족이 참여하려면 이 코드를 그대로 옮겨 적어야 하는데, 손으로
 * 받아쓰면 틀리기 쉽다. 코드 옆에서 바로 복사하거나 메신저로 보낼 수
 * 있게 한다.
 *
...
export default function FamilyCodeShare({
  ...
  return (
    <div>
      ...
      {/* aria-live: 복사 결과가 스크린리더에도 읽히게 한다. */}
      <p className="text-xs text-gray-700 mt-1" aria-live="polite">
        {notice || "가족이 이 코드로 참여할 수 있습니다."}
      </p>
    </div>
  );
}
